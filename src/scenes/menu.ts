...
import { GAMEWIDTH, GAMEHEIGHT, MENUWIDTH, PM_FONT } from '../config'
...
export default new Phaser.Class({
    ...
    create: function(): void {
        ...
        button.on('pointerout', hoverFunction(this, X_CENTER, BUTTON_Y, BUTTON_INDEX, 0));
        button.on('pointerover', hoverFunction(this, X_CENTER, BUTTON_Y, BUTTON_INDEX, 4))
